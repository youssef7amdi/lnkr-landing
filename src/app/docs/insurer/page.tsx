  ...
  en: {
    ...
    Registration: [
      <>
        ...
        <ul className="ml-6 list-inside list-disc">
          Enter Insurer Manager info: full name, mobile & password. Enter Insurer info: name & phone number.
        </ul>
      </>,
      <>
        To login, go to:{' '}
    ...
    'Manage Users': [
      ...
      <>
        ...
        <ul className="ml-6 list-inside list-disc">
          <li> Approval Employee: responsible for processing approvals from doctors. Allowed to access: Approvals, Beneficiaries & Network. </li> 
          <li> Accountant: handling billings. Allowed to access: Beneficiary, Network & More. </li>
        </ul>
      </>,
      <>
        The Insurer Manager is allowed to access everything except: Search Patient & Pending Results.
      </>,
    ],
    Requests: [
  ...
  ar: {
    ...
    التسجيل: [
      <>
        لإنشاء حساب جديد:{' '}
        <ul className="ml-6 list-inside list-disc">
        أدخل معلومات مدير التأمين: الإسم الكامل، والهاتف المحمول وكلمة المرور. أدخل معلومات التأمين: الإسم، ورقم الهاتف.
        </ul>
      </>,
      <>
    ...
    'إدارة المستخدمين': [
      ...
      <>
        ...
        <ul className="ml-6 list-inside list-disc">
          <li> موظف الموافقات: المسؤول عن معالجة الموافقات من الأطباء. المسموح لهم بالوصول إلى: الموافقات والمستفيدين والشبكة. </li>
          <li> المحاسب: معالجة الفواتير. يُسمح بالوصول إلى: المستفيد والشبكة والمزيد.</li>
        </ul>
      </>,
