  ...
  en: {
    ...
    Registration: [
      <>
        ...
        <ul className="ml-6 list-inside list-disc">
          Enter Pharmacy Manager info: full name, mobile & password. Enter Pharmacy Center info: name & phone number.
        </ul>
      </>,
      <>
        To login, go to:{' '}
    ...
    'Manage Users': [
      ...
      <>
        ...
        <ul className="ml-6 list-inside list-disc">
          <li> Pharmacist: responsible for direct contact with patients. Allowed to access: Search Patient.</li>
          <li> Accountant: handling billings. Allowed to access: Contracts & More. </li>
        </ul>
      </>,
      <>
        The Pharmacy Manager is allowed to access everything except: Search Patient.
      </>,
    ],
    'Search Patient': [
  ...
  ar: {
    ...
    التسجيل: [
      <>
        لإنشاء حساب جديد:{' '}
        <ul className="ml-6 list-inside list-disc">
        أدخل معلومات مدير الصيدلة التحاليل: الإسم الكامل، والهاتف المحمول وكلمة المرور. أدخل معلومات الصيدلة التحاليل: الإسم، ورقم الهاتف.
        </ul>
      </>,
      <>
    ...
    'إدارة المستخدمين': [
      ...
      <>
        ...
        <ul className="ml-6 list-inside list-disc">
          <li>الصيدلي: مسؤولون عن الاتصال المباشر مع المرضى. مسموح لهم بالوصول إلى: البحث عن نتائج المرضى والمعلقة.</li>
